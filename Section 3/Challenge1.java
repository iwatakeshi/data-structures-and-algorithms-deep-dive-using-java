/**
 * Challenge1: Merge sort in descening order
 */
public class Challenge1 {
    ...
    private static void merge(int[] array, int start, int mid, int end) {
        ...
        // is greater than the right partiton's first element.
        // If so, then the entire left partions is greater than the right.
